...
BASE_IMAGE="ocamlcross/osx-${SYSTEM_TYPE}-base:${OCAML_VERSION}"
...
SKIPPED="ocaml-osx32.${OCAML_VERSION} ocaml-osx64.${OCAML_VERSION} ocaml-osx.${OCAML_VERSION} conf-gcc-windows64.1 conf-gcc-windows32.1"
# these packages just fail
SKIPPED="${SKIPPED} lwt-zmq-windows.2.1.0 zmq-windows.4.0-7"

PRETEST_IMAGE="ocamlcross/osx-${SYSTEM_TYPE}-pretest:${OCAML_VERSION}"
